    ...
    <section>
      <div className="max-w-7xl mx-auto justify-center lg:p-[8] p-5">
        ...
        <div className="lg:flex items-center justify-between lg:mt-2 mt-1">
          ...
          <button className="bg-[#E0F780] text-[#193D6F] lg:w-fit w-full lg:mt-0 mt-3 text-sm lg:px-6 py-3 px-2 rounded-lg font-medium lg:text-lg font-campton md:hover:bg-[#193D6F] md:hover:text-[#fff] transition duration-300 ease-in-out">
            Book a call
          </button>
        </div>
