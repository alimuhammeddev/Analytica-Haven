  ...
  return (
    <section>
      ...
      <div className="max-w-7xl mx-auto p-5 -mt-5 font-campton">
        ...
        <p>
          Day two was all about rolling up sleeves and getting into action.
          Participants were guided through a hands-on workshop using
          beginner-friendly tools like Microsoft Excel for data cleaning, Google
          Colab for Python basics, and even experimented with pre-trained AI
          models. No prior coding experience? No problem. The instructors
          patiently walked attendees through each task, ensuring no one was left
          behind.
        </p>
