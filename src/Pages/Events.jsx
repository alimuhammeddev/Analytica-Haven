    ...
    <section className="font-campton">
      ...
      <div className="max-w-7xl mx-auto md:my-[6rem] my-[2rem]">
        <div className="flex flex-col md:flex-row justify-center">
            <h2 className="text-center text-[#000] text-[1.2rem] font-semibold pb-5 w-[100%] px-5 md:hidden block">
          ...
          <div className="md:w-[40%] w-[100%] px-5 md:px-10 py-5 md:bg-[#ebf2fe]">
            <h2 className="text-[#000] md:text-[1.5rem] text-[1.2rem] font-semibold pb-5 md:block hidden">
              We Empower Minds,
            ...
            <Link
              to="/community"
              className="bg-[#E0F780] px-3 py-2 rounded-md text-[#193D6F] mt-[2rem] w-fit hover:bg-[#193D6F] hover:text-white transition-colors duration-300 md:block hidden"
            >
              Join Us Now
            </Link>
          </div>
